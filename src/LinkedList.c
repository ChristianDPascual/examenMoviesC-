 ...
 *
 * \param void* this la LinkedList a filtrar
 * \param void* (int) pfunc*(void*) puntero a la funcion que filtra al elemento enviado
 * \return LinkedList* puntero a una nueva LinkedList ya filtrada
 *
 */
